...
export const messages = {
  ...
  "market.title": { en: "Market — Binance spot", vi: "Thị trường — Binance spot" },
  ...
  "market.futures.title": { en: "Market — Binance Futures (USD-M)", vi: "Thị trường — Binance Futures (USD-M)" },
